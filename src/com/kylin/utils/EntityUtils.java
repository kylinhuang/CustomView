...
public class EntityUtils {
	...
	private static ArrayList<ItemEntity> initTabNew() {
		...
		setItem.name = "匆匆那些年";
		setItem.nameSize = 25;
		setItem.image_content_type = 1;
		setItem.image_content_uri = "http://f.hiphotos.baidu.com/baike/c0%3Dbaike116%2C5%2C5%2C116%2C38/sign=82e87630262dd42a4b0409f9625230d0/96dda144ad345982e775c6cb0ff431adcaef84ef.jpg";
//		setItem.image_icon = R.drawable.system_settings_image;
		arrItem.add(setItem);
		
		ItemEntity tvItem = new ItemEntity();
		tvItem.hasNameBg = true;
		tvItem.id = 51;
		...
		tvItem.name = "重返地球";
		tvItem.nameSize = 25;
		tvItem.image_content_type = 1;
		tvItem.image_content_uri = "http://image.baidu.com/i?tn=download&ipn=dwnl&word=%E7%94%B5%E5%BD%B1%E6%B5%B7%E6%8A%A5%E5%9B%BE&ie=utf-8&fr=result&url=http%3A%2F%2Fdown1.sucaitianxia.com%2Fpsd02%2Fpsd179%2Fpsds36925.jpg";
//		tvItem.image_icon = R.drawable.system_settings_image;
		arrItem.add(tvItem);
		
		ItemEntity lookbackItem = new ItemEntity();
		lookbackItem.hasNameBg = true;
		lookbackItem.id = 52;
		...
		lookbackItem.image_content_type =1;
		lookbackItem.image_content_uri = "http://image.baidu.com/i?tn=download&ipn=dwnl&word=%E7%94%B5%E5%BD%B1&ie=utf-8&fr=result&url=http%3A%2F%2Fwww.ln.chinanews.com%2FUploadFiles%2F2014%2F8%2F201408051648340612.jpg";
...
//		arrItem.add(adItem);
	...
	private static ArrayList<ItemEntity> initTabUser() {
		...
		setItem.nameSize = 25;
		setItem.image_content_type = 1;
		setItem.image_content_uri = "http://e.hiphotos.baidu.com/baike/c0%3Dbaike272%2C5%2C5%2C272%2C90/sign=e0e4cc8f39292df583cea447dd583705/838ba61ea8d3fd1f353eab9a334e251f95ca5f5e.jpg";
//		setItem.image_icon = R.drawable.system_settings_image;
		arrItem.add(setItem);
		...
		tvItem.nameSize = 25;
		tvItem.image_content_type = 1;
		tvItem.image_content_uri = "http://image.baidu.com/i?tn=download&ipn=dwnl&word=%E5%A4%A9%E9%99%8D%E9%9B%84%E7%8B%AE&ie=utf-8&fr=result&url=http%3A%2F%2Ff.hiphotos.baidu.com%2Fzhidao%2Fpic%2Fitem%2Fdcc451da81cb39dbfb89d81ed3160924ab183028.jpg";
//		tvItem.image_icon = R.drawable.system_settings_image;
		arrItem.add(tvItem);
		...
		lookbackItem.image_content_type = 1;
		lookbackItem.image_content_uri = "http://image.baidu.com/i?tn=download&ipn=dwnl&word=%E4%B8%AD%E5%9B%BD%E5%90%88%E4%BC%99%E4%BA%BA&ie=utf-8&fr=result&url=http%3A%2F%2Fwww.lizhi123.net%2Fuploads%2Fallimg%2F130525%2F4_130525175139_1.png";
...
//		adItem.image_icon = R.drawable.system_settings_image;
	...
	private static ArrayList<ItemEntity> initTabTV() {
		...
		ghItem.name = "歌华有线";
		ghItem.nameSize = 25;
		ghItem.image_content = R.drawable.item_bg;
		ghItem.image_icon = R.drawable.system_settings_image;
		arrItem.add(ghItem);
		...
		bstItem.name = "百事通";
		bstItem.nameSize = 25;
		bstItem.image_content = R.drawable.item_bg;
		bstItem.image_icon = R.drawable.system_settings_image;
		arrItem.add(bstItem);
